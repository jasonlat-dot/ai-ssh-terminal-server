package com.jasonlat.ai.infrastructure.security;
...
public class PasswordEncryptor {
    ...
    public PasswordEncryptor(@Value("${app.config.ssh-default-secret-key}") String secretKey) {
        // 确保密钥长度为 32 字节（AES-256）
        byte[] keyBytes = padOrTrim(secretKey.getBytes(StandardCharsets.UTF_8), 32);
