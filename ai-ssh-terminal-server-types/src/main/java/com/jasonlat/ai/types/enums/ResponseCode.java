...
public enum ResponseCode {
    ...
    CHAT_ATTACHMENT_SIZE_MISMATCH("CHAT_ATTACHMENT_SIZE_MISMATCH", "附件实际大小与上传记录不一致，请重新上传文件"),
    CHAT_ATTACHMENT_CHECKSUM_MISSING("CHAT_ATTACHMENT_CHECKSUM_MISSING", "附件上传记录缺少有效的 SHA-256 摘要，请重新上传文件"),
    CHAT_ATTACHMENT_CHECKSUM_MISMATCH("CHAT_ATTACHMENT_CHECKSUM_MISMATCH", "附件内容摘要与上传记录不一致，请重新上传文件"),
    CHAT_ATTACHMENT_IMAGE_INVALID("CHAT_ATTACHMENT_IMAGE_INVALID", "无法识别图片格式，请使用有效的 PNG、JPEG 或 WebP 图片"),
    CHAT_ATTACHMENT_PDF_INVALID("CHAT_ATTACHMENT_PDF_INVALID", "附件内容不是可识别的 PDF 文件，请检查文件格式"),
    CHAT_ATTACHMENT_TEXT_ENCODING_INVALID("CHAT_ATTACHMENT_TEXT_ENCODING_INVALID", "文本附件不是有效的 UTF-8 编码，请转换为 UTF-8 后重新上传"),
    CHAT_ATTACHMENT_TEXT_CONTENT_INVALID("CHAT_ATTACHMENT_TEXT_CONTENT_INVALID", "文本附件包含不支持的控制字符或二进制内容，请检查文件格式"),
